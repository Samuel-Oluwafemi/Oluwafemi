const stack = {
  Build: ["React", "TypeScript", "Node.js", "JavaScript", "Vite", "Tailwind CSS"],
  Connect: [
    "Firebase",
    "Supabase",
    "REST APIs",
    ...
    <section className="py-20 sm:py-24 lg:py-28" id="tech">
      <div className="container mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 max-w-4xl font-['Space_Grotesk'] text-4xl font-medium 
          leading-tight tracking-[-0.055em] text-slate-100 sm:text-5xl lg:text-6xl">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          {Object.entries(stack).map(([group, items]) => (
            <article
              ...
              key={group}
            >
              <span className="font-['JetBrains_Mono'] text-[11px] font-bold uppercase 
